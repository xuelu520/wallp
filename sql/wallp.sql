...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-01-08 18:15:08
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
ALTER TABLE `open_login` ADD `token` VARCHAR(255) NOT NULL COMMENT 'token' , ADD `expire_time` INT(11) NOT NULL COMMENT '过期时间' , ADD INDEX (`token`, `expire_time`) ;
